package ru.akhitev.kb.java6.multithreading.tasks_priority_queue;

import java.util.concurrent.PriorityBlockingQueue;
import java.util.concurrent.TimeUnit;

import static ru.akhitev.kb.java6.multithreading.tasks_priority_queue.TicketStatus.IN_PROGRESS;
import static ru.akhitev.kb.java6.multithreading.tasks_priority_queue.TicketStatus.RESOLVED;
