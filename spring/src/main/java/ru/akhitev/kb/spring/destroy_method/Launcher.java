package ru.akhitev.kb.spring.destroy_method;
...
public class Launcher {
    ...
    private static void genericXmlApplicationContextWithDestroySingletons() {
        GenericXmlApplicationContext context = new GenericXmlApplicationContext("spring/destroy_method/beans.xml");
    ...
    private static void abstractApplicationContextWithClose() {
        AbstractApplicationContext context = new GenericXmlApplicationContext("spring/destroy_method/beans.xml");
        context.getBean(Retro.class);
        context.close();
    }

    private static void justApplicationContext() {
        ApplicationContext context = new GenericXmlApplicationContext("spring/destroy_method/beans.xml");
        context.getBean(Retro.class);
    }
